...
namespace CsharpSwatchesTest
{
    ...
    public class CodeWarsKataTest
    {
        ...
        #region YourOrderPlease tests

        [TestMethod]
        public void YourOrderPlease_1()
        {
            Assert.AreEqual("Thi1s is2 3a T4est", CodeWarsKata.YourOrderPlease("is2 Thi1s T4est 3a"));
        }

        [TestMethod]
        public void YourOrderPlease_2()
        {
            Assert.AreEqual("Fo1r the2 g3ood 4of th5e pe6ople", CodeWarsKata.YourOrderPlease("4of Fo1r pe6ople g3ood th5e the2"));
        }

        [TestMethod]
        public void YourOrderPlease_3()
        {
            Assert.AreEqual("", CodeWarsKata.YourOrderPlease(""));
        }
